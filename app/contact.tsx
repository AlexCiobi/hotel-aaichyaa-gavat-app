...
const CONTACTS = [
  ...
  },
  {
    icon: '✉️',
    label: 'Email',
    value: 'info@aaichyaagavat.in',
    action: () => Linking.openURL('mailto:info@aaichyaagavat.in'),
  },
  {
    icon: '📍',
    label: 'Get Directions',
    value: 'Bavaskar Building, RB Road, Ichalkaranji',
    action: () => Linking.openURL('https://maps.google.com/?q=Hotel+Aaichyaa+Gavat+Ichalkaranji'),
  },
]
      ...
      >
        ...
        <View style={{ backgroundColor: '#fff', borderRadius: 16, padding: 16 }}>
          ...
          <Text style={{ color: '#666', lineHeight: 22, fontSize: 14 }}>
            ...
            Bavaskar Building, RB Road{'\n'}
            Kagwade Mala, Ichalkaranji{'\n'}
            Maharashtra 416115
          </Text>
          <TouchableOpacity
            onPress={() => Linking.openURL('https://maps.google.com/?q=Hotel+Aaichyaa+Gavat+Ichalkaranji')}
            style={{
              marginTop: 14,
