...
const translations: Record<Language, Strings> = {
  en: {
    ...
    settings: 'Settings', aboutUs: 'About Hotel Aaichyaa Gavat', callUs: 'Call Us', whatsappUs: 'WhatsApp',
  ...
  mr: {
    ...
    settings: 'सेटिंग्ज', aboutUs: 'हॉटेल आईच्या गावात बद्दल', callUs: 'फोन करा', whatsappUs: 'व्हॉट्सअ‍ॅप',
  ...
  hi: {
    ...
    settings: 'सेटिंग', aboutUs: 'होटेल आईच्या गावात के बारे में', callUs: 'कॉल करें', whatsappUs: 'व्हाट्सएप',
  ...
  kn: {
    ...
    settings: 'ಸೆಟ್ಟಿಂಗ್ಸ್', aboutUs: 'ಹೋಟೆಲ್ ಆಈಚ್ಯಾ ಗಾವತ್ ಬಗ್ಗೆ', callUs: 'ಕರೆ ಮಾಡಿ', whatsappUs: 'ವಾಟ್ಸ್‌ಆಪ್',
